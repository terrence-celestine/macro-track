...
const globalStore = globalThis as unknown as Record<symbol, MockState | undefined>
...
export const queueSelect = (...values: unknown[]) => mocks.selectQueue.push(...values)

/** Queue the values the text prompt should return, in order. */
export const queueText = (...values: unknown[]) => mocks.textQueue.push(...values)

/** Queue the answers the confirm prompt should return, in order. */
export const queueConfirm = (...values: unknown[]) => mocks.confirmQueue.push(...values)
